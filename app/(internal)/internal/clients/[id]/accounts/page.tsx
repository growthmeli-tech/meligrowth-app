  ...
  return (
    <main className="p-4 md:p-6 space-y-6">
      <header className="space-y-2">
        ...
        <h1 className="text-xl font-bold text-[#1A1A1A]">Cuentas Mercado Libre</h1>
      ...
      <section className="rounded-xl border border-[#E8E8E2] bg-white p-4">
        <h2 className="text-sm font-bold uppercase tracking-wide text-[#1A1A1A]">Invitaciones</h2>
        {!invites?.length ? (
          <p className="mt-3 text-sm text-[#6B6B6B]">Todavía no hay invitaciones para esta empresa.</p>
        ) : (
